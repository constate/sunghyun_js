...
- 객체 method에 사용되는 this는 해당 객체를 의미함
- 객체 method에서 객체 property를 사용할 때는 this를 사용해서 객체를 명시 해야함
...
> 변수 적용(접근) 범위
>
> - Block Scope : 블럭 범위 - 명령문 / 구문 코드블럭 영역
> - Function Scope : 함수 범위 - 함수 선언 영역
> - Global Scope : 전역 범위 - 프로그래밍 전체 영역

> 변수 Scope 적용원리
>
> - 전역, 함수, 블럭 영역이 포함 관계로 되어 있을 때 적용 가능
> - 포함하고 있는 큰 영역에서 선언된 변수는 포함되는 작은 영역에서 사용 가능
> - 포함되는 작은 영역에서 선언된 변수는 포함하는 큰 영역에서 사용 불가능
...
> function으로 정의되는 일반 함수와 화살표 함수는 this의 의미가 다름
>
> - 일반 함수 : 최종적으로 함수를 호출한 대상의 객체 => this
> - 화살표 함수 : 함수가 포함된 최상위 객체 => this
...
>
> - window : Browser 관련 최상위 객체

### DOM Access Method

> HTML4 API
>
> - id 이름으로 DOM Access : document.getElementById('id이름');
> - class 이름으로 DOM Access : document.getElementsByClassName('class이름');
> - Tag 이름으로 DOM Access : document.getElementsByTagName('tag이름');
...
> Create(생성)
>
> - DOM 생성 : Javascript에서 HTML Element 동적 생성
>   - HTML 직접 코딩 => 정적 코딩
>
> Read
>
